...
public class LandingController {
    ...
    @FXML private void handleRegisterAction(ActionEvent event) { showInfoAlert("Registrasi", "Fitur registrasi akan segera tersedia!"); }
    @FXML private void handleLoginAction(ActionEvent event) { showInfoAlert("Login", "Fitur login akan segera tersedia!"); }
