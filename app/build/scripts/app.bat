...
<<<<<<< HEAD
set CLASSPATH=%APP_HOME%\lib\app.jar;%APP_HOME%\lib\javafx-fxml-21.0.3-win.jar;%APP_HOME%\lib\javafx-controls-21.0.3-win.jar;%APP_HOME%\lib\javafx-graphics-21.0.3-win.jar;%APP_HOME%\lib\sqlite-jdbc-3.42.0.0.jar;%APP_HOME%\lib\javafx-base-21.0.3-win.jar
=======
...
@rem Execute app
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APP_OPTS%  -classpath "%CLASSPATH%" com.meditrack.MainApp %*
